...
from model.asc_pair import ASCModel as Model
from utils.asc_pair_datamodule import DataModule
from utils.asc_result import Result
...
class LightningModule(pl.LightningModule):
    def __init__(self, hparams, data_module):
        ...
        self.config.num_sentiment_labels = 3
